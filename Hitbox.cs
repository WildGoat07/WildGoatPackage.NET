...
namespace WGP
{
    ...
    /// Base of any hitbox.
    /// </summary>
    public class Hitbox : Transformable, ICloneable
    {
        ...
        /// </summary>
        protected internal List<Tuple<List<Vector2f>, CombineMode>> Vertices;
        ...
        protected Hitbox()
        {
            Vertices = new List<Tuple<List<Vector2f>, CombineMode>>();
        }
        ...
        public bool Collision(Vector2f pt) => Collision(pt, new Vector2f(-999999, -999999));
